...
*Defined in [operators/innerFilter.ts:19:27](https://github.com/Alorel/rxutils/blob/3fadbc6/src/operators/innerFilter.ts#L19).*
...
*Defined in [operators/innerFilter.ts:41:27](https://github.com/Alorel/rxutils/blob/3fadbc6/src/operators/innerFilter.ts#L41).*