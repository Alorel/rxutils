...
*Defined in [operators/pickProps.ts:33:25](https://github.com/Alorel/rxutils/blob/5d6fec1/src/operators/pickProps.ts#L33).*
...
*Defined in [operators/pickProps.ts:61:25](https://github.com/Alorel/rxutils/blob/5d6fec1/src/operators/pickProps.ts#L61).*