...
*Defined in [operators/pickProps.ts:34:25](https://github.com/Alorel/rxutils/blob/37f00a0/src/operators/pickProps.ts#L34).*
...
*Defined in [operators/pickProps.ts:62:25](https://github.com/Alorel/rxutils/blob/37f00a0/src/operators/pickProps.ts#L62).*