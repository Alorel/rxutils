...
[![Build Status](https://travis-ci.com/Alorel/rxutils.svg?branch=1.5.0)](https://travis-ci.com/Alorel/rxutils)
[![Coverage Status](https://coveralls.io/repos/github/Alorel/rxutils/badge.svg?branch=1.5.0)](https://coveralls.io/github/Alorel/rxutils?branch=1.5.0)
...
Full API docs and examples for version 1.5.0 are available [here](https://github.com/Alorel/rxutils/tree/1.5.0/docs).
